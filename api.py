...
def find_process_tj():
    ...
    print(nome_parte, numero_processo)

    if not numero_processo:
        return {
            "error": "O campo 'numeroProcesso' são obrigatórios."
        }, 400
    ...
    # headers = {
    #     'Cookie': f'MO={cookies["MO"]}; JSESSIONID={cookies["JSESSIONID"]}; AWSALBAPP-1={cookies["AWSALBAPP-1"]}; AWSALBAPP-2={cookies["AWSALBAPP-2"]}; AWSALBAPP-3={cookies["AWSALBAPP-3"]}; OAuth_Token_Request_State={cookies["OAuth_Token_Request_State"]}; AWSALBAPP-0={cookies["AWSALBAPP-0"]}',
